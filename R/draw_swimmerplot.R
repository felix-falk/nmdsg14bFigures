...
#'
#' @param plot_data Data frame containing the data for the swimmer plot rectangles.
...
#' @examples
#' swimmerplot(plot_data, immune_pts, outcome_pts, treatment_pts, gvhd_pts, title_string)
