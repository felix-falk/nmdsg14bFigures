# Protocol: CD3 Antibody Titration
Author: Felix Falk
...
- Brilliant Violet 510 anti-human CD19 ([BioLegend, 302242](https://nordicbiosite.com/product/302242/Brilliant-Violet-510tm-antihuman-CD19))
...
| ------- | ---------- | ------------- | --------------------- | ------------- | ------------ | ---------------- |
| T cells | CD3        | FITC          | CD19                  | BV510         | 1:100        | 1                |

# Protocol
## 1: Calculate Number of Samples
We have _1_ antibody to be titrated at *5* concentrations. 1 x 5 = 5 titration samples. We have _2_ FMO samples (CD3, 7AAD), _2_ single-stain samples (CD3, 7AAD) and _1_ unstained sample, for a total of _10_ samples.
...
1. Performed in BSL2, in hood with light switched off. Keep samples cool throughout.
	...
	2. Spin down antibody stock tubes (CD3-FITC and CD19-BV510) to clear aggregates (2000 g, 1 min, 4°C). Use start/select button to confirm the settings in the TCR3 microcentrifuge.
	...
	4. Pipet 5 µl CD3-FITC antibody stock solution into first serial dilution tube (Table 3).
	5. Pipet 2.5 µl CD19-BV510 antibody stock solution into co-stain master mix (Table 4).
...
| ------------ | ------------------ | ------------------- | -------------------------- | ------- | --------------------- |
| CD19-BV510   | 1:100              | 1:25                | 0.25                       |         | 2.5 (from AB stock)   |
| FACS buffer  |                    |                     | 12.25                      |         | 122.5                 |
| **Total**    |                    |                     | **12.5**                   |         | **125**               |

Table 5. FMO samples. Pipet CD3 antibody from stock solution.
